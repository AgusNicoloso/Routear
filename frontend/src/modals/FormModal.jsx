...
class FormModal extends Component {
  ...
  onSubmit = () => {
    ...
    axios
      .post(
        `http://localhost:3001/${this.props.modalId}`,
        qs.stringify(children.props.values),
        {
          headers: {
          ...
          <Fragment>
            <ModalHeader toggle={toggleModal}>
              ...
              <ul className="nav list-inline ml-auto float-right">
                {dirty && (
                  <li className="list-inline-item pl-2 right">
                    <p className="mb-0">
                      <small>
            ...
            <ModalFooter>
              <Button color="primary" type="submit" onClick={this.onSubmit}>
                {modalId === "login" ? "Ingresar" : "Guardar"}
              </Button>{" "}
              <Button
                color="warning"
